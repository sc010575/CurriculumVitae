...
class RootViewPage {
    ...
    @discardableResult
    func expectDataErrorDialogue(file: String = #file, line: UInt = #line) -> RootViewPage {
        expect(self.app?.staticTexts["Data error"].exists, file: file, line: line).toEventually(beTrue())
        return self
    }
